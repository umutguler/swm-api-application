...
{
    [TestFixture]
    public class SwmApiServiceAgeTest
    {
        ...
        [Test]
        public async Task GetFirstNamesByAgeCsv_Positve_BillFrank()
        {
            string expected = "bill,frank";
            var swmApiService = new SwmApiService(MockHttpClientFactory.Object, MockLoggerFactory.Object);

            var result = await swmApiService.GetFirstNamesByAgeCsv(23);
        ...
        [Test]
        public async Task GetFirstNamesByAgeCsv_Negative_Null()
        {
            var swmApiService = new SwmApiService(MockHttpClientFactory.Object, MockLoggerFactory.Object);
            var result = await swmApiService.GetFirstNamesByAgeCsv(0);
            Assert.That(result, Is.Empty);
        }
    }
}